#!/usr/bin/env bash
# opencode.sh — OpenCode xreview adapter.
#
# Contract (xreview ADR-11):
#   - Args: <prompt-file> <model> <final-out-file>
#   - stdout: must be empty; orchestrator merges stdout+stderr into log
