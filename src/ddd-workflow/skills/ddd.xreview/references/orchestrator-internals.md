...
```text
src/ddd-workflow/scripts/shared/agent-runner.sh                         # shared runner 實體檔
src/ddd-workflow/skills/ddd.xreview/scripts/xreview-orchestrator.sh -> ../../../scripts/shared/agent-runner.sh
src/ddd-workflow/skills/ddd.work/scripts/work-orchestrator.sh       -> ../../../scripts/shared/agent-runner.sh
```

`xreview-orchestrator.sh` 與 `work-orchestrator.sh` 都 symlink 到同一個 `src/ddd-workflow/scripts/shared/agent-runner.sh`。Runner mode 由 invocation basename 決定：
